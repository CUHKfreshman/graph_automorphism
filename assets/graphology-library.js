(function (global, factory) {
   ...
   * @return {boolean}
   */
  var isGraph$L = function isGraph(value) {
    return (
      value !== null &&
      typeof value === 'object' &&
   ...
   * Exporting.
   */
  assertions$2.isGraph = isGraph$L;
